...
// Class takes care of loading assetBundle and its dependencies automatically, loading variants automatically.
    public class AssetBundleManagerOld : IAssetManager
    {
        #region static data
        
        private static AssetBundleManagerOld _this;
        ...
        public static AssetBundleManagerOld Instance
        {
            ...
            {
                if (_this == null)
                    _this = new AssetBundleManagerOld(AssetSimulationOperationProvider.IsSimulateMode);
                return _this;
            }
        }
        ...
        protected AssetBundleManagerOld(bool simulateMode)
        {
