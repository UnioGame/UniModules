namespace UniGreenModules.AssetBundleManager.Editor.AssetBundleManagerReferencesViewer
{
    using System.Collections.Generic;
    using Runtime;
    using Runtime.AssetBundleResources;
    using UnityEditor;
    using UnityEngine;
    ...
    public class AssetBundleManagerReferencesWindow : EditorWindow {

        private static AssetBundleManagerReferencesWindow _window;
        ...
        [MenuItem("Tools/AssetBundles/Asset Bundle References")]
        static void Initialize()
        {
            // Get existing open window or if none, make a new one:
            _window = (AssetBundleManagerReferencesWindow)EditorWindow.GetWindow(typeof(AssetBundleManagerReferencesWindow));
            _window.Show();
        }
