...
namespace Assets.Tools.UnityTools.ResourceSystem
{
    ...
    public class ResourceBase
    {
        ...
        {
#if UNITY_EDITOR
            UnityEditor.AssetDatabase.LoadAssetAtPath<T>(this.assetPath);
#endif
            return null;
        }
        ...
        public IEnumerator<byte> LoadAudioClip(System.Action<AudioClip> callback)
        {
            ...
            if (this.loadableResource == true)
            {
                ...
                else
                {
                    ...
                    callback.Invoke(ResourcesProvider.Load<AudioClip>(this.resourcesPath));
        ...
        public virtual bool Validate(Object item)
        {
            ...
            var itemPath = UnityEditor.AssetDatabase.GetAssetPath(item);
        ...
        {
            var assetImporter = UnityEditor.AssetImporter.GetAtPath(budnleResourcePath);
