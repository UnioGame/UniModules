...
namespace CommandTerminal
{
    ...
    public class Terminal : MonoBehaviour
    {
        ...
        void SetupWindow()
        {
            ...
            offset_window = new Vector2(Screen.width, Screen.height) * Offset;

            var windowY = current_open_t - real_window_size;
            ...
            window_style.padding = new RectOffset(Mathf.RoundToInt(offset_window.x + 4), 4, 
                Mathf.RoundToInt(offset_window.y + 4f), 4);
        ...
        void DrawConsole(int Window2D)
        {
            ...
            if (ShowGUIRunButton && GUILayout.Button("| run", input_style, GUILayout.Width(Screen.width / 10)))
            {
                EnterCommand();
            }
