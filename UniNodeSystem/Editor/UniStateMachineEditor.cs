...
namespace UniStateMachine
{
    ...
    public class UniStateMachineEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            _nodesScroll = EditorDrawerUtils.DrawScroll(_nodesScroll, () => DrawStates(nodeSelector));
        ...
        {
            var result = AssetEditorTools.SaveAssetAsNested<UniStateSelector>(stateMachine, "StateSelector");
            if (result)
            {
